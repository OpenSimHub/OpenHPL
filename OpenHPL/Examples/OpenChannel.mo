...
model OpenChannel "Model of a hydropower system with open channel model"
  ...
  Waterway.Pipe discharge(H = 0, L = 10) annotation(
  ...
  Waterway.Pipe pipe(H = 0, L = 10) annotation(
    Placement(transformation(extent = {{20, -10}, {40, 10}})));
equation
  connect(discharge.o, openChannel.i) annotation(
    Line(points = {{-20, 0}, {-10, 0}}, color = {0, 128, 255}));
  connect(openChannel.o, pipe.i) annotation(
    Line(points = {{10, 0}, {20, 0}}, color = {0, 128, 255}));
  connect(reservoir.o, discharge.i) annotation(
    Line(points = {{-60, 0}, {-40, 0}}, color = {0, 128, 255}));
  connect(pipe.o, tail.o) annotation(
