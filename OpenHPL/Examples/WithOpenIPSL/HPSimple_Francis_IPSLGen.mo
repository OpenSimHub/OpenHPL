...
model HPSimple_Francis_IPSLGen "Synergy with OpenIPSL library(generator)"
  ...
  OpenHPL.Waterway.Pipe discharge(L=600, H=0.5) annotation (Placement(transformation(extent={{50,20},{70,40}})));
