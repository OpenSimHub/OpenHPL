...
model SimpleGen2 "Model of a simple generator with mechanical connectors"
  ...
  parameter SI.Power Pn = 10e6 "Nominal power of the generator"
   annotation (Dialog(group = "Name plate data"));
  ...
  Modelica.Blocks.Nonlinear.Limiter torqueLimit(uMax=Pn/w_0) annotation (Placement(transformation(
        extent={{6,6},{-6,-6}},
        rotation=180,
        origin={-40,26})));
equation
  ...
  connect(speedSensor.w, limiter.u) annotation (Line(points={{-41,-40},{-62.8,-40}},           color={0,0,127}));
  connect(limiter.y, loadPtoT.u2) annotation (Line(points={{-76.6,-40},{-90,-40},{-90,20},{-82,20}},
                                                                                          color={0,0,127}));
