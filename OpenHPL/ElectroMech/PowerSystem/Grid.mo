...
model Grid "Model of a mechanical grid equivalent"
  ...
  Modelica.Blocks.Math.Feedback dF annotation (Placement(transformation(extent={{40,-70},{20,-50}})));
...
equation
  ...
  connect(realExpression.y, dF.u2) annotation (Line(points={{21,-80},{30,-80},{30,-68}}, color={0,0,127}));
  connect(dF.y, P.u2) annotation (Line(points={{21,-60},{-90,-60},{-90,64},{-82,64}}, color={0,0,127}));
