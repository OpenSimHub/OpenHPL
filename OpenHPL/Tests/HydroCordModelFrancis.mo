...
model HydroCordModelFrancis "Model of HP system with simplified models for penstock, turbine, etc."
  ...
  OpenHPL.Waterway.Pipe penstock1(
    ...
    D_o=4.7,
    H=233,
    L=363) annotation (Placement(transformation(
        origin={10,50},
        extent={{-10,-10},{10,10}},
        rotation=-90)));
  OpenHPL.Waterway.SurgeTank surgeTank(
    ...
    h_0=62.5) annotation (Placement(transformation(
        origin={-4,66},
        extent={{-10,-10},{10,10}})));
  inner OpenHPL.Data data(Vdot_0=0.00618496) annotation (Placement(transformation(
        origin={-90,92},
        extent={{-10,-10},{10,10}})));
  ...
  OpenHPL.Waterway.Pipe penstock2(
    ...
    D_o=3.3,
    H=102.5 + 2.5,
    L=145) annotation (Placement(transformation(
        origin={18,10},
        extent={{-10,-10},{10,10}},
        rotation=-90)));
...
equation
  ...
  connect(per_gain.y, Francis.u_t) annotation (
    Line(points={{-7,-72},{38,-72},{38,14},{32,14},{32,4},{32,4}},              color = {0, 0, 127}));
  ...
  connect(limiter1.y, per_gain.u) annotation (
    Line(points={{-39,-70},{-35,-70},{-35,-72},{-29,-72},{-29,-72},{-30,-72},
          {-30,-72}},                                                                                   color = {0, 0, 127}));
  connect(Francis.n, discharge1.p) annotation (
    Line(points = {{42, -8}, {44, -8}, {44, -14}, {44, -14}}, color = {28, 108, 200}));
