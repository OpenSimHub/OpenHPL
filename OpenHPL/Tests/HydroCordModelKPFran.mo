...
model HydroCordModelKPFran "Model of HP system with simplified models for penstock, turbine, etc."
  ...
  OpenHPL.Waterway.SurgeTank surgeTank(
    ...
    h_0=62.5) annotation (Placement(transformation(
        origin={-4,66},
        extent={{-10,-10},{10,10}})));
  inner OpenHPL.Data data(Vdot_0=0.00618434) annotation (Placement(transformation(
        origin={-90,90},
        extent={{-10,-10},{10,10}})));
...
equation
  ...
  connect(rot_gain.y, francis1.w_in) annotation (
    Line(points={{-39,-36},{6,-36},{6,-12},{18,-12}},            color = {0, 0, 127}));
  ...
  connect(limiter1.y, per_gain.u) annotation (
    Line(points={{-41,-68},{-40,-68},{-40,-68},{-39,-68},{-39,-70},{-33,-70},{-33,-73},{-33,-70},{-32,-70}},                    color = {0, 0, 127}));
