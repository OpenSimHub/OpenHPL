...
model HPLiniarizationGenIPSLKP "Synergy with OpenIPSL library(generator + governor)"
  ...
  OpenHPL.Waterway.Reservoir reservoir(h_0=48) annotation (Placement(transformation(
        origin={-92,46},
        extent={{-10,-10},{10,10}})));
  OpenHPL.Waterway.Pipe intake(H=23, Vdot_0=18.536) annotation (Placement(transformation(extent={{-76,36},{-56,56}})));
  OpenHPL.Waterway.Pipe discharge(
    H=0.5,
    L=600,
    Vdot_0=18.5359) annotation (Placement(transformation(extent={{50,38},{70,58}})));
  OpenHPL.Waterway.Reservoir tail(h_0=5) annotation (Placement(transformation(
        origin={92,52},
        extent={{-10,10},{10,-10}},
        rotation=180)));
  OpenHPL.Waterway.SurgeTank surgeTank(h_0=69.9695) annotation (Placement(transformation(
        origin={-36,50},
        extent={{-10,-10},{10,10}})));
  ...
  OpenIPSL.Electrical.Loads.PSAT.LOADPQ_variation pwLoadPQ2(P_0 = 8 * 5, Q_0 = 6 * 5, V_0 = 1, angle_0 = 0, dP1 = 1, dP2 = 0, dQ1 = 0, dQ2 = 0, t_end_1 = 1.1e10, t_end_2 = 1e10, t_start_1 = 1e10, t_start_2 = 1e10) annotation (
    Placement(transformation(origin = {90.0335, -38.2889}, extent = {{-6.2889, -6.0335}, {6.2889, 6.0335}}, rotation = 90)));
  OpenIPSL.Electrical.Buses.Bus bus annotation (
    Placement(transformation(extent = {{-14, -38}, {6, -18}})));
  ...
  OpenIPSL.Electrical.Buses.Bus bus2(displayPF = true) annotation (
    Placement(transformation(extent = {{66, -16}, {86, 4}})));
  OpenIPSL.Electrical.Buses.Bus bus3 annotation (
    Placement(transformation(extent = {{66, -48}, {86, -28}})));
  ...
  OpenHPL.Waterway.PenstockKP penstockKP(
    ...
    h_s0=69.9694,
    p_p0={9.93615,14.0954,18.2545,22.4134,26.5723,30.7309,34.8895,39.0479,43.2061,47.3643}*1e5) annotation (Placement(transformation(
        origin={-4,42},
        extent={{-10,-10},{10,10}})));
equation
