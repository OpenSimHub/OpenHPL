...
model HPLiniarizationGenIPSL "Synergy with OpenIPSL library(generator + governor)"
  ...
  Waterway.Reservoir reservoir(H_r=48) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=0)));
  OpenHPL.Waterway.Pipe intake(H=23, Vdot_0=18.5381) annotation (Placement(visible=true, transformation(extent={{-76,52},{-56,72}}, rotation=0)));
  ...
  Waterway.Pipe penstock(
    ...
    D_i=3,
    D_o=3,
    Vdot_0=18.5381) annotation (Placement(visible=true, transformation(
        origin={-10,48},
        extent={{-10,-10},{10,10}},
        rotation=-90)));
  OpenHPL.Waterway.SurgeTank surgeTank(h_0=69.9692) annotation (Placement(visible=true, transformation(
        origin={-36,66},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  ...
  inner OpenIPSL.Electrical.SystemBase SysData annotation (
    Placement(visible = true, transformation(extent = {{-98, -100}, {-74, -80}}, rotation = 0)));
...
equation
  connect(bus.p, infiniteBus.p) annotation (
    Line(points = {{-4, -76}, {-20, -76}, {-20, -54}, {-42, -54}, {-42, -54}, {-42, -54}}, color = {0, 0, 255}));
  ...
  connect(RealizerAng.y, turbine.w_in) annotation (
    Line(points = {{41, 10}, {36, 10}, {32, 10}, {32, 25.8}}, color = {0, 0, 127}));
  annotation (
    experiment(StopTime = 2000, StartTime = 0, Tolerance = 0.0001, Interval = 0.4));
end HPLiniarizationGenIPSL;
