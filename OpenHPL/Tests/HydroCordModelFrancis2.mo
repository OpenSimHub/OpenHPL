...
model HydroCordModelFrancis2 "Model of HP system with simplified models for penstock, turbine, etc."
  ...
  OpenHPL.Waterway.SurgeTank surgeTank(
    ...
    L=87,
    p_eps=0.1,
    h_0=62.4882) annotation (Placement(transformation(
        origin={-4,66},
        extent={{-10,-10},{10,10}})));
  inner OpenHPL.Data data(Vdot_0=1.925) annotation (Placement(transformation(
        origin={-90,92},
        extent={{-10,-10},{10,10}})));
  ...
  Modelica.Blocks.Math.Add add1(k2 = -1) annotation (
    Placement(transformation(origin = {74, -28}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
