...
model HydroCordModelKPFran2 "Model of HP system with simplified models for penstock, turbine, etc."
  ...
  OpenHPL.Waterway.SurgeTank surgeTank(
    ...
    H=75.5,
    L=87,
    h_0=62.4945) annotation (Placement(transformation(
        origin={-4,66},
        extent={{-10,-10},{10,10}})));
  inner OpenHPL.Data data(Vdot_0=2.044) annotation (Placement(transformation(
        origin={-90,90},
        extent={{-10,-10},{10,10}})));
  ...
  OpenHPL.Waterway.PenstockKP penstockKP1(
    ...
    h_s0=62.4945) annotation (Placement(transformation(
        origin={18,52},
        extent={{-10,-10},{10,10}})));
  OpenHPL.Waterway.PenstockKP penstockKP2(
    ...
    N=5,
    PipeElasticity=false,
    h_s0=62.4945 + 233) annotation (Placement(transformation(
        origin={8,4},
        extent={{-10,-10},{10,10}})));
