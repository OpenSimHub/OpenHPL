...
model HydroCordModelKP2 "Model of HP system with simplified models for penstock, turbine, etc."
  ...
  OpenHPL.Waterway.SurgeTank surgeTank(
    ...
    h_0=62.4956) annotation (Placement(visible=true, transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=0)));
  inner OpenHPL.Parameters Const(V_0=1.82328) annotation (Placement(visible=true, transformation(
        origin={-90,90},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  ...
  OpenHPL.Waterway.PenstockKP penstockKP1(
    ...
    h_s0=62.4956) annotation (Placement(visible=true, transformation(
        origin={18,52},
        extent={{-10,-10},{10,10}},
        rotation=0)));
  OpenHPL.Waterway.PenstockKP penstockKP2(
    ...
    N=5,
    PipeElasticity=false,
    h_s0=62.4956 + 233) annotation (Placement(visible=true, transformation(
        origin={8,4},
        extent={{-10,-10},{10,10}},
        rotation=0)));
