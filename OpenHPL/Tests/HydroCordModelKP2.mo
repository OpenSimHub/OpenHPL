...
model HydroCordModelKP2 "Model of HP system with simplified models for penstock, turbine, etc."
  ...
  OpenHPL.Waterway.SurgeTank surgeTank(
    ...
    H=75.5,
    L=87,
    h_0=62.4956) annotation (Placement(transformation(
        origin={-4,66},
        extent={{-10,-10},{10,10}})));
  inner OpenHPL.Data data(Vdot_0=1.82328) annotation (Placement(transformation(
        origin={-90,90},
        extent={{-10,-10},{10,10}})));
  ...
  OpenHPL.Waterway.PenstockKP penstockKP1(
    ...
    h_s0=62.4956) annotation (Placement(transformation(
        origin={18,52},
        extent={{-10,-10},{10,10}})));
  OpenHPL.Waterway.PenstockKP penstockKP2(
    ...
    N=5,
    PipeElasticity=false,
    h_s0=62.4956 + 233) annotation (Placement(transformation(
        origin={8,4},
        extent={{-10,-10},{10,10}})));
...
equation
  //turbine.u_t = 4.54929515955115/100;
