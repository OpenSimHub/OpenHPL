...
model Model_X_Double_Mix22 "Two pipes elastic and elastic"
  ...
  OpenHPL.Waterway.PenstockKP penKP2(D_i = 0.7, H = 203.7, L = 1008.6) annotation (
  ...
  OpenHPL.Waterway.PenstockKP penKP21(D_i = 0.7, H = 182, L = 997.6) annotation (
...
equation
  ...
  connect(ramp.y, switch2.u3) annotation (
    Line(points={{-25,42},{-12,42},{-12,41.8},{2.2,41.8}},
                                        color = {0, 0, 127}));
  connect(penKP2.o, turbine7.i) annotation (
    Line(points = {{-2, 10}, {26, 10}}, color = {0, 128, 255}));
  ...
  connect(penKP21.o, penKP2.i) annotation (
    Line(points = {{-38, 10}, {-22, 10}}, color = {0, 128, 255}));
  connect(reservoir.o, penKP21.i) annotation (
