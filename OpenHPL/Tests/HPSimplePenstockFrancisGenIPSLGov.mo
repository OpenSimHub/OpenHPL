...
equation
  ...
  connect(tGTypeI.pm, turbine.u_t) annotation (
    Line(points = {{38, 86}, {28, 86}, {28, 46}, {28, 46}}, color = {0, 0, 127}));
  connect(Normilizer.u, turbine.P_out) annotation (
    Line(points = {{-14, -26}, {-20, -26}, {-20, 12}, {24, 12}, {24, 25.4}}, color = {0, 0, 127}));
  //turbine.u_t = u;
  connect(reservoir.n, intake.p) annotation (
    Line(points = {{-80, 62}, {-72, 62}}, color = {28, 108, 200}));
  connect(surgeTank.p, intake.n) annotation (
    Line(points = {{-42, 66}, {-48, 66}, {-48, 62}, {-54, 62}}, color = {28, 108, 200}));
  connect(surgeTank.n, penstock.p) annotation (
    Line(points = {{-24, 66}, {-16.95, 66}, {-16.95, 57.9}, {-10.1, 57.9}}, color = {28, 108, 200}));
