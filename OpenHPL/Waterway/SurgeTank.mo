...
model SurgeTank "Model of the surge tank/shaft"
  ...
  parameter SI.Diameter L_t = 5 "If Throttle value type: Diameter of throat" annotation (
    Dialog(group = "Geometry",enable=SurgeTankType == OpenHPL.Types.SurgeTank.STThrottleValve));
  ...
  parameter SI.VolumeFlowRate Vdot_0 = 0 "Initial flow rate in the surge tank" annotation (
    Dialog(group = "Initialization"));
  ...
  SI.VolumeFlowRate Vdot(start = Vdot_0) "Water flow rate";
