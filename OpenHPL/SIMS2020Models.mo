...
extends Modelica.Icons.ExamplesPackage;
  ...
  model TrollheimDraftTube "Model of Trollheim HPP with draft tube."
    extends Modelica.Icons.Example;
    OpenHPL.Waterway.Reservoir reservoir(H_r=50) annotation (Placement(visible=true, transformation(
          origin={-90,30},
          extent={{-10,-10},{10,10}},
  ...
  equation
    ...
    annotation (
      experiment(
        ...
        Interval=0.4,
        __Dymola_Algorithm="Dassl"));
  end TrollheimDraftTube;

  model TorpaDraftTube "Model of Torpa HPP with air-cushion surge tank."
    extends Modelica.Icons.Example;
    OpenHPL.Waterway.Reservoir reservoir(H_r=200)
                                                 annotation (Placement(visible=true, transformation(
          origin={-90,30},
