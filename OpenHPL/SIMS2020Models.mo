...
extends Modelica.Icons.ExamplesPackage;
  ...
  model TrollheimConicalDT "Model of Trollheim HPP with draft tube."
    extends Modelica.Icons.Example;
    OpenHPL.Waterway.Reservoir reservoir(H_r=50) annotation (Placement(visible=true, transformation(
          origin={-90,30},
          extent={{-10,-10},{10,10}},
    ...
    OpenHPL.Waterway.Pipe discharge(
      ...
      L=700,
      D_i=6,
      D_o=6)                                      annotation (Placement(visible=true, transformation(extent={{60,-40},
              {80,-20}},                                                                                                        rotation=0)));
    OpenHPL.Waterway.Reservoir tail(H_r=5, Input_level=false) annotation (Placement(visible=true, transformation(
          origin={90,-70},
          extent={{-10,10},{10,-10}},
    ...
    Waterway.DraftTube draftTube(
      DraftTubeType=OpenHPL.Types.DraftTube.ConicalDiffuser,
                                 D_i = 4, D_o = 4.978, H = 7, L = 7.017,
      L_m=4,
      L_b=3,
      theta_moody=90)
  ...
  equation
    ...
    connect(turbine.u_t, control.y)
      annotation (Line(points={{30,22},{30,70},{1,70}}, color={0,0,127}));
    connect(draftTube.o, discharge.i)
      annotation (Line(points={{40,-30},{60,-30}}, color={28,108,200}));
    connect(turbine.o, draftTube.i) annotation (Line(points={{40,10},{44,10},{
            44,-8},{20,-8},{20,-30}}, color={28,108,200}));
    connect(discharge.o, tail.o) annotation (Line(points={{80,-30},{80,-48},{64,
            -48},{64,-70},{80,-70}}, color={28,108,200}));
    annotation (
      experiment(
        StartTime=-2000,
        StopTime=1000,
        Interval=0.4,
        __Dymola_Algorithm="Dassl"));
  end TrollheimConicalDT;

  model TrollheimMoodyDT "Model of Trollheim HPP with draft tube."
    extends Modelica.Icons.Example;
    OpenHPL.Waterway.Reservoir reservoir(H_r=50) annotation (Placement(visible=true, transformation(
          origin={-90,30},
          extent={{-10,-10},{10,10}},
