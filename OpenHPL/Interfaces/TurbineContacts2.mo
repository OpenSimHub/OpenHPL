...
partial model TurbineContacts2 "Model of turbine connectors"
  ...
  parameter Boolean enableP_out = false "Enable additional P_out connector"
  ...
  input Modelica.Blocks.Interfaces.RealInput u_t "[Guide vane|nozzle] opening of the turbine" annotation (Placement(transformation(
        ...
        rotation=-90,
        origin={-80,120})));
  Modelica.Blocks.Interfaces.RealOutput P_out(unit="W") if enableP_out "Mechanical Output power" annotation (
