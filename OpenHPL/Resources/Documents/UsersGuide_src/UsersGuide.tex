...
\item[\texttt{Parameters}] A record that determines the common parameters for this library. It is possible to insert this class into models and use the common parameters for the whole model.
