...
record Parameters "Provides a set of base parameters for this library"
  ...
  parameter Real gamma_air = 1.4 "Polytropic constant for air at STD" annotation (
    Dialog(group = "Properties"));
  parameter Real T_0 = 273 + 25 "Room temperature, K" annotation (
    Dialog(group = "Properties"));
  parameter Real M_a = 28.96e-3 "Molar mass of air, kg/mol" annotation (
    Dialog(group = "Properties"));
  parameter Real R = 8.314 "Universal gas constant, J/K/mol" annotation (
    Dialog(group = "Properties"));
