...
model TestRunoff
  ...
  OpenHPL.Waterway.Reservoir reservoir1(
    ...
    L=5000,
    UseInFlow=true,
    W=1000) annotation (Placement(transformation(origin={-58,40}, extent={{-10,-10},{10,10}})));
  OpenHPL.Waterway.RunOff_zones runOff annotation (Placement(transformation(extent={{-102,40},{-82,60}})));
  ...
  OpenHPL.Waterway.Pipe intake(H=23) annotation (Placement(transformation(extent={{-36,26},{-16,46}})));
  OpenHPL.Waterway.Pipe discharge(H=0.5, L=600) annotation (Placement(transformation(extent={{56,-2},{76,18}})));
  ...
  OpenHPL.Waterway.Pipe penstock(
    ...
    L=600) annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=-90)));
  OpenHPL.Waterway.SurgeTank surgeTank(h_0=69.9) annotation (Placement(transformation(origin={2,42}, extent={{-10,-10},{10,10}})));
  OpenHPL.ElectroMech.Turbines.Turbine turbine(C_v=3.7) annotation (Placement(transformation(origin={40,12}, extent={{-10,-10},{10,10}})));
