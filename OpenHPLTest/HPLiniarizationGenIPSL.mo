...
model HPLiniarizationGenIPSL "Synergy with OpenIPSL library(generator + governor)"
  ...
  OpenHPL.Waterway.Pipe intake(H=23, Vdot_0=18.5381) annotation (Placement(transformation(extent={{-76,52},{-56,72}})));
  OpenHPL.Waterway.Pipe discharge(
    L=600,
    H=0.5,
    Vdot_0=18.5381) annotation (Placement(transformation(extent={{50,30},{70,50}})));
  ...
  OpenHPL.Waterway.Pipe penstock(
    ...
    D_i=3,
    D_o=3,
    Vdot_0=18.5381) annotation (Placement(transformation(
        origin={-10,48},
        extent={{-10,-10},{10,10}},
        rotation=-90)));
  OpenHPL.Waterway.SurgeTank surgeTank(h_0=69.9692) annotation (Placement(transformation(
        origin={-36,66},
        extent={{-10,-10},{10,10}})));
  ...
  inner OpenIPSL.Electrical.SystemBase SysData annotation (
    Placement(transformation(extent = {{-98, -100}, {-74, -80}})));
