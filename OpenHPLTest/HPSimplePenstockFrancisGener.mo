...
model HPSimplePenstockFrancisGener "HP system model with Francis turbine and generator"
  ...
  OpenHPL.Waterway.Reservoir tail(h_0=10) annotation (Placement(transformation(
        ...
        extent={{-10,10},{10,-10}},
        rotation=180)));
  OpenHPL.ElectroMech.Generators.SynchGen unit(UseFrequencyOutput=true) annotation (Placement(transformation(extent={{18,-4},{38,16}})));
  ...
  OpenHPL.ElectroMech.Turbines.Francis turbine(
    ...
    r_v=1.1,
    w_1_=0.2,
    w_v_=0.2) annotation (Placement(transformation(origin={28,38}, extent={{-10,-10},{10,10}})));
...
end HPSimplePenstockFrancisGener;
