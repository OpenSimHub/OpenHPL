...
model HPSimplePenstockGeneratorTest "Generator testing for HP"
  ...
  OpenHPL.Waterway.Pipe intake(H=23) annotation (Placement(transformation(extent={{-64,52},{-44,72}})));
  OpenHPL.Waterway.Pipe discharge(L=600, H=0.5) annotation (Placement(transformation(extent={{46,26},{66,46}})));
  ...
  OpenHPL.Waterway.PenstockKP penstock(
    ...
    N=10) annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=-90)));
  OpenHPL.Waterway.SurgeTank surgeTank(h_0=71) annotation (Placement(transformation(origin={-22,66}, extent={{-10,-10},{10,10}})));
  ...
  inner OpenHPL.Data data annotation (Placement(transformation(
        origin={-90,92},
        extent={{-10,-10},{10,10}})));
  OpenHPL.ElectroMech.Generators.SynchGen generator(k_b=1000, J=850000) annotation (Placement(transformation(extent={{18,-4},{38,16}})));
