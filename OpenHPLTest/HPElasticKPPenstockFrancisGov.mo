...
model HPElasticKPPenstockFrancisGov "HP system model with Francis turbine and elastic penstock and governor"
  ...
  inner OpenHPL.Data data annotation (Placement(transformation(
        origin={-90,92},
        extent={{-10,-10},{10,10}})));
  OpenHPL.Waterway.Pipe intake(H=23) annotation (Placement(transformation(extent={{-76,54},{-56,74}})));
  OpenHPL.Waterway.Pipe discharge(L=600, H=0.5) annotation (Placement(transformation(extent={{56,30},{76,50}})));
  OpenHPL.Waterway.Reservoir tail(h_0=5) annotation (Placement(transformation(
        origin={94,46},
        extent={{-10,10},{10,-10}},
        rotation=180)));
  OpenHPL.Waterway.SurgeTank surgeTank(h_0=69.9) annotation (Placement(transformation(extent={{-44,60},{-24,80}})));
  ...
  OpenHPL.ElectroMech.Turbines.Francis francis(
    ...
    WaterCompress=true) annotation (Placement(transformation(
        origin={40,40},
        extent={{-10,-10},{10,10}})));
  OpenHPL.ElectroMech.Generators.SynchGen generator(P_op=100e6, Q_op=62.5e6) annotation (Placement(transformation(
        origin={40,10},
        extent={{-10,-10},{10,10}})));
  OpenHPL.Controllers.Governor governor(
    a=7.862E-25,
    c=1.108E-08,
    d=-5.344E-02,
  ...
  OpenHPL.Waterway.Fitting fitting(D_1=3, D_2=1.632) annotation (Placement(transformation(extent={{4,30},{24,50}})));
equation
