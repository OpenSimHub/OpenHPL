...
model TestFitingSimpleHP "Model of HP system with pipe fitting"
  ...
  OpenHPL.Waterway.Pipe conduit(
    H=25,
    L=6600,
    Vdot_0=19.06) annotation (Placement(transformation(origin={-66,14}, extent={{-10,-10},{10,10}})));
  OpenHPL.Waterway.Reservoir reservoir annotation (Placement(transformation(origin={-92,14}, extent={{-10,-10},{10,10}})));
  OpenHPL.Waterway.Pipe discharge(
    H=5,
    L=600,
    Vdot_0=19.06) annotation (Placement(transformation(origin={64,-30}, extent={{-10,-10},{10,10}})));
  OpenHPL.ElectroMech.Turbines.Turbine turbine(C_v=3.7) annotation (Placement(transformation(origin={40,-14}, extent={{-10,-10},{10,10}})));
  OpenHPL.Waterway.Reservoir tail(h_0=10) annotation (Placement(transformation(origin={92,-30}, extent={{10,-10},{-10,10}})));
  ...
  OpenHPL.Waterway.Fitting fitting(
    D_1=conduit.D_o,
    D_2=penstock.D_i,
  ...
  OpenHPL.Waterway.Pipe penstock(
    ...
    D_i=3.3,
    D_o=3.3,
    Vdot_0=19.06) annotation (Placement(transformation(origin={10,-4}, extent={{-10,-10},{10,10}})));
  OpenHPL.Waterway.SurgeTank surgeTank annotation (Placement(transformation(extent={{-50,4},{-30,24}})));
  ...
  OpenHPL.ElectroMech.Generators.SimpleGen unit(SteadyState=false) annotation (Placement(transformation(extent={{30,-50},{50,-30}})));
equation
