...
model HPLiniarizationKP "HP system model for liniarization with elastic penstock (KP)"
  ...
  OpenHPL.Waterway.PenstockKP penstock(
    ...
    p_p0=997*9.81*(69 + 428.5/10/2):997*9.81*428.5/10:997*9.81*(69 + 428.5/10*(10 - 1/2))) annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=-90)));
  OpenHPL.Waterway.SurgeTank surgeTank(h_0=69.908) annotation (Placement(transformation(origin={-30,66}, extent={{-10,-10},{10,10}})));
  inner OpenHPL.Data data annotation (Placement(transformation(
        origin={-90,92},
        extent={{-10,-10},{10,10}})));
  OpenHPL.ElectroMech.Turbines.Turbine turbine(C_v=3.7, WaterCompress=true) annotation (Placement(transformation(origin={10,34}, extent={{-10,-10},{10,10}})));
equation
