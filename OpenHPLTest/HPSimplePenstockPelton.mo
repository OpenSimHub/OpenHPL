...
model HPSimplePenstockPelton "HP system model with Pelton turbine"
  ...
  OpenHPL.Waterway.Pipe intake(H=23) annotation (Placement(transformation(extent={{-72,50},{-52,70}})));
  ...
  OpenHPL.Waterway.Pipe penstock(
    ...
    L=700) annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=-90)));
  OpenHPL.Waterway.SurgeTank surgeTank(h_0=69.9) annotation (Placement(transformation(origin={-30,66}, extent={{-10,-10},{10,10}})));
  inner OpenHPL.Data data annotation (Placement(transformation(
        origin={-90,92},
        extent={{-10,-10},{10,10}})));
  OpenHPL.ElectroMech.Turbines.Pelton turbine(
    R=1.74/2,
    D_0=1,
    enable_P_out=true) annotation (Placement(transformation(origin={10,34}, extent={{-10,-10},{10,10}})));
