...
model HPLiniarizationFranGen "HP system model for liniarization with Francis turbine + generator"
  ...
  OpenHPL.Waterway.Pipe penstock(
    ...
    Vdot_0=18.5952) annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=-90)));
  OpenHPL.Waterway.SurgeTank surgeTank(h_0=69.963) annotation (Placement(transformation(origin={-30,66}, extent={{-10,-10},{10,10}})));
  ...
  OpenHPL.ElectroMech.Turbines.Francis turbine(
    ...
    Given_losses=false,
    u_end_=2.3683,
    u_start_=2.24) annotation (Placement(transformation(origin={10,34}, extent={{-10,-10},{10,10}})));
