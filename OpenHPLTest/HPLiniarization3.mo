...
model HPLiniarization3 "Simple HP system model for liniarization"
  ...
  OpenHPL.Waterway.Pipe intake(H=23, Vdot_0=19.0777) annotation (Placement(transformation(extent={{-72,50},{-52,70}})));
  ...
  OpenHPL.Waterway.Pipe penstock(
    ...
    Vdot_0=19.0777) annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=-90)));
  OpenHPL.Waterway.SurgeTank surgeTank(h_0=69.908, p_2=data.p_a) annotation (Placement(transformation(origin={-30,66}, extent={{-10,-10},{10,10}})));
  inner OpenHPL.Data data annotation (Placement(transformation(
        origin={-90,92},
        extent={{-10,-10},{10,10}})));
  OpenHPL.ElectroMech.Turbines.Turbine turbine(C_v=3.7) annotation (Placement(transformation(origin={10,34}, extent={{-10,-10},{10,10}})));
equation
