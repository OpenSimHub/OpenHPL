...
model HPElasticKPPenstockANDIntake "Model of HP system with elastic penctock and intake (KP), but simplified models for turbine, etc."
  ...
  OpenHPL.Waterway.PenstockKP Intake(
    D_i=5.8,
    D_o=5.8,
    H=23,
    L=6600,
    ...
    PipeElasticity=true,
    h_s0=48,
    p_p0=997*9.81*(48 + 23/110/2):997*9.81*23/110:997*9.81*(48 + 23/110*(110 - 1/2))) annotation (Placement(transformation(origin={-62,68}, extent={{-10,-10},{10,10}})));
  OpenHPL.Waterway.Pipe discharge(
    D_i=5.8,
    D_o=5.8,
    H=0.5,
    L=600) annotation (Placement(transformation(origin={48,40}, extent={{-10,-10},{10,10}})));
equation
