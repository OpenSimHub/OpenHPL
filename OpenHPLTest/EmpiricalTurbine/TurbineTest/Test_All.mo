...
//
Test_Turbine_Charactersistics T1(Hn=100) annotation(
    Placement(transformation(origin = {-60, 90}, extent = {{-10, -10}, {10, 10}})));
Test_Turbine_Charactersistics T2(Hn=200) annotation(
    Placement(transformation(origin = {-60, 70}, extent = {{-10, -10}, {10, 10}})));
Test_Turbine_Charactersistics T3(Hn=300) annotation(
    Placement(transformation(origin = {-60, 50}, extent = {{-10, -10}, {10, 10}})));
Test_Turbine_Charactersistics T4(Hn=400) annotation(
    Placement(transformation(origin = {-60, 30}, extent = {{-10, -10}, {10, 10}})));
Test_Turbine_Charactersistics T5(Hn=500) annotation(
