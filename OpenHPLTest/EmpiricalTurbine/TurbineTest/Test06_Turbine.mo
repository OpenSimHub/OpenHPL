...
model Test06_Turbine
 ...
 OpenHPL.Waterway.Pipe pipe(H = 0, L = 1000, D_i = 1.128379167, SteadyState = false, Vdot_0 = 2.0)  annotation(
 ...
 OpenHPL.Waterway.Pipe pipe2(D_i = 1.128379167, H = 0, L = 1000, SteadyState = false, Vdot_0 = 2.0) annotation(
