...
model CaseStudingValentynasCase "HP system model for Valentyna's Master case"
  ...
  OpenHPL.Waterway.Pipe penstock1(
    ...
    L=200) annotation (Placement(transformation(
        ...
        extent={{-10,-10},{10,10}},
        rotation=-90)));
  OpenHPL.Waterway.Fitting fitting1(D_1=4, D_2=3) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=270,
        origin={-16,40})));
  OpenHPL.Waterway.SurgeTank surgeTank(D=4.5, h_0=48 + 45.5) annotation (Placement(transformation(origin={-42,74}, extent={{-10,-10},{10,10}})));
equation
