...
model HPTaperedFittingsTest "Test for comparing fitting behaviour"
  ...
  OpenHPL.Waterway.Pipe pipe2(
    H=5,
    L=100,
    D_i=4) annotation (Placement(transformation(extent={{-60,12},{-40,32}})));
  OpenHPL.Waterway.Pipe tail2(
    H=0,
    L=100,
    D_i=2) annotation (Placement(transformation(extent={{40,12},{60,32}})));
  OpenHPL.Waterway.Fitting TaperedReductionRev(
    fit_type=OpenHPL.Types.Fitting.Tapered,
    D_i=4,
    D_o=2,
  ...
  OpenHPL.Waterway.Fitting TaperedExpansionRev(
    fit_type=OpenHPL.Types.Fitting.Tapered,
    D_i=2,
    D_o=4,
