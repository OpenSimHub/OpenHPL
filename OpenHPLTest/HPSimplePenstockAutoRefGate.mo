...
model HPSimplePenstockAutoRefGate
  ...
  OpenHPL.Waterway.Pipe intake(Vdot_0=19) annotation (Placement(transformation(extent={{-64,52},{-44,72}})));
  ...
  OpenHPL.Waterway.Reservoir tail(h_0=10) annotation (Placement(transformation(
        ...
        extent={{-10,10},{10,-10}},
        rotation=180)));
  OpenHPL.ElectroMech.Generators.SimpleGen unit(w_0=52.4) annotation (Placement(transformation(extent={{16,-4},{36,16}})));
